...
<html lang="en">
  ...
  <title>php-date-formatter/php-date-formatter.min.js at master · kartik-v/php-date-formatter · GitHub</title>
    <meta name="description" content="A Javascript datetime formatting and manipulation library using PHP date-time formats.">
    <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">
  <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
  <meta property="fb:app_id" content="1401488693436528">

    
    <meta property="og:image" content="https://avatars2.githubusercontent.com/u/3592619?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="kartik-v/php-date-formatter" /><meta property="og:url" content="https://github.com/kartik-v/php-date-formatter" /><meta property="og:description" content="php-date-formatter - A Javascript datetime formatting and manipulation library using PHP date-time formats." />

  <link rel="assets" href="https://assets-cdn.github.com/">
  
  <meta name="pjax-timeout" content="1000">
  
  <meta name="request-id" content="D41C:2E90:1E0620E:37687F3:5B695E31" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="D41C:2E90:1E0620E:37687F3:5B695E31" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta http-equiv="x-pjax-version" content="700876a5dd140d89e45f2e0d69338be6">
      ...
      <link href="https://github.com/kartik-v/php-date-formatter/commits/master.atom" rel="alternate" title="Recent Commits to php-date-formatter:master" type="application/atom+xml">

  <meta name="go-import" content="github.com/kartik-v/php-date-formatter git https://github.com/kartik-v/php-date-formatter.git">

  <meta name="octolytics-dimension-user_id" content="3592619" /><meta name="octolytics-dimension-user_login" content="kartik-v" /><meta name="octolytics-dimension-repository_id" content="22133458" /><meta name="octolytics-dimension-repository_nwo" content="kartik-v/php-date-formatter" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="22133458" /><meta name="octolytics-dimension-repository_network_root_nwo" content="kartik-v/php-date-formatter" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />


    <link rel="canonical" href="https://github.com/kartik-v/php-date-formatter/blob/master/js/php-date-formatter.min.js" data-pjax-transient>
...
>
  <div class="position-relative">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="22133458" data-scoped-search-url="/kartik-v/php-date-formatter/search" data-unscoped-search-url="/search" action="/kartik-v/php-date-formatter/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=8pOO49txAbdlT1jiXmwawcVxpsbanvCewRGqkm484rCIDVOGwH6KP0465CHhsLnzCTedY0j/PPqHRuOHKJkUlA=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <a class="HeaderMenu-target text-white no-underline mr-3" href="/login?return_to=%2Fkartik-v%2Fphp-date-formatter%2Fblob%2Fmaster%2Fjs%2Fphp-date-formatter.min.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:dropdowns">Sign&nbsp;in</a>
  ...
  <li>
      <a href="/login?return_to=%2Fkartik-v%2Fphp-date-formatter"
    class="btn btn-sm btn-with-count tooltipped tooltipped-n"
    aria-label="You must be signed in to watch a repository" rel="nofollow">
    <svg class="octicon octicon-eye v-align-text-bottom" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8.06 2C3 2 0 8 0 8s3 6 8.06 6C13 14 16 8 16 8s-3-6-7.94-6zM8 12c-2.2 0-4-1.78-4-4 0-2.2 1.8-4 4-4 2.22 0 4 1.8 4 4 0 2.22-1.78 4-4 4zm2-4c0 1.11-.89 2-2 2-1.11 0-2-.89-2-2 0-1.11.89-2 2-2 1.11 0 2 .89 2 2z"/></svg>
    Watch
  </a>
  <a class="social-count" href="/kartik-v/php-date-formatter/watchers"
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/kartik-v/php-date-formatter/stargazers"
  ...
  <li>
    ...
    <a href="/kartik-v/php-date-formatter/network/members" class="social-count"
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" href="/kartik-v">kartik-v</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="/kartik-v/php-date-formatter">php-date-formatter</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /kartik-v/php-date-formatter" href="/kartik-v/php-date-formatter">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a itemprop="url" data-hotkey="g i" class="js-selected-navigation-item reponav-item" data-selected-links="repo_issues repo_labels repo_milestones /kartik-v/php-date-formatter/issues" href="/kartik-v/php-date-formatter/issues">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a data-hotkey="g p" itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /kartik-v/php-date-formatter/pulls" href="/kartik-v/php-date-formatter/pulls">
    ...
    <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /kartik-v/php-date-formatter/projects" href="/kartik-v/php-date-formatter/projects">
  ...
  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /kartik-v/php-date-formatter/pulse" href="/kartik-v/php-date-formatter/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/kartik-v/php-date-formatter/blob/d842e1c4e6a8d6108017b726321c305bb5ae4fb5/js/php-date-formatter.min.js">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:b8e91a1d3ac3bc01b68072232d200624 -->

      <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="D8dQ1jla7EmDxM5NcXDN3IIfMNCfj+E/7id87e26Ju7EpdygXiKNdi6XBmKyyniIXX9GFZ/I6AWM4jipuRf3MQ==" />
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/kartik-v/php-date-formatter/blob/master/js/php-date-formatter.min.js"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/kartik-v/php-date-formatter/tree/v1.3.5/js/php-date-formatter.min.js"
              data-name="v1.3.5"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/kartik-v/php-date-formatter/tree/v1.3.4/js/php-date-formatter.min.js"
              data-name="v1.3.4"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/kartik-v/php-date-formatter/tree/v1.3.3/js/php-date-formatter.min.js"
              data-name="v1.3.3"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/kartik-v/php-date-formatter/tree/v1.3.2/js/php-date-formatter.min.js"
              data-name="v1.3.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/kartik-v/php-date-formatter/tree/v1.3.1/js/php-date-formatter.min.js"
              data-name="v1.3.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/kartik-v/php-date-formatter/tree/v1.3.0/js/php-date-formatter.min.js"
              data-name="v1.3.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/kartik-v/php-date-formatter/tree/v1.2.0/js/php-date-formatter.min.js"
              data-name="v1.2.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
    ...
    <div class="BtnGroup float-right">
      <a href="/kartik-v/php-date-formatter/find/master"
    ...
    <div id="blob-path" class="breadcrumb">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/kartik-v/php-date-formatter"><span>php-date-formatter</span></a></span></span><span class="separator">/</span><span class="js-path-segment"><a data-pjax="true" href="/kartik-v/php-date-formatter/tree/master/js"><span>js</span></a></span><span class="separator">/</span><strong class="final-path">php-date-formatter.min.js</strong>
    </div>
  </div>


  <include-fragment src="/kartik-v/php-date-formatter/contributors/master/js/php-date-formatter.min.js" class="commit-tease commit-loader">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/kartik-v/php-date-formatter/raw/master/js/php-date-formatter.min.js">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/kartik-v/php-date-formatter/blame/master/js/php-date-formatter.min.js">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/kartik-v/php-date-formatter/commits/master/js/php-date-formatter.min.js">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * @copyright Copyright &amp;copy; Kartik Visweswaran, Krajee.com, 2014 - 2018</span></td>
      </tr>
      <tr>
        <td id="L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * @version 1.3.5</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC5" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * Date formatter utility library that allows formatting date/time variables or Date objects using PHP DateTime format.</span></td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * This library is a standalone javascript library and does not depend on other libraries or plugins like jQuery. The</span></td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * library also adds support for Universal Module Definition (UMD).</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC9" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * @see http://php.net/manual/en/function.date.php</span></td>
      </tr>
      <tr>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/kartik-v/php-date-formatter/blame/d842e1c4e6a8d6108017b726321c305bb5ae4fb5/js/php-date-formatter.min.js">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" role="menuitem" href="/kartik-v/php-date-formatter/issues/new">Open new issue</a></li>
      </ul>
    </details-menu>
  </details>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.26663s from unicorn-3300369029-gljt8">GitHub</span>, Inc.</li>
